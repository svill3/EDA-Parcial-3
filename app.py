...
def mostrar_pagina_B(usuario):
    while True:
        ...
        os.system('cls' if os.name == 'nt' else 'clear')
        print(colored(f'Bienvenido, {usuario.nombre}', 'green')) 
...
def buscar_libros(usuario):
    ...
    if usuario.libro_actual is None and usuario.historial == []:
        ...
        for libro in lista_libros:
            print(colored(f'    ID: {libro[0]}, Título: {libro[1]}. Autores: {libro[2]}, {libro[3]}, {libro[4]}. Año: {libro[5]}. Materia: {libro[6]}', 'yellow'))
